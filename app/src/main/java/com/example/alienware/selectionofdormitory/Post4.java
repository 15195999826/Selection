...
public class Post4 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBackBtn = (ImageView)findViewById(R.id.back4);
    ...
    void initViews() {
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                //((StudentInfo)getApplication()).setBuildnum(tvResult);
                //获取Spinner控件的适配器
                select3 = (String) sp.getSelectedItem();
                //int i = Integer.parseInt(select3);
                ((StudentInfo)getApplication()).setBuildnum(select3);
